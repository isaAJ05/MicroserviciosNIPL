            ...
            {showUserPanel && (
              ...
              >
                ...
                <button
                  ...
                  onClick={async () => {
                    // Renovar token automáticamente antes de cerrar sesión
                    const email = user ? (user.username || user.name || user.email) : '';
                    const password = localStorage.getItem('userPassword') || '';
                    const tokenContract = localStorage.getItem('tokenContract') || '';
                    if (email && password && tokenContract) {
                      try {
