...
def main(data=None):
    """
    Consulta una tabla en Roble usando el token y parámetros recibidos.
    Args:
        data: dict con 'token', 'tableName' y filtros opcionales (por ejemplo, 'age')
    Returns:
    ...
    try:
        ...
        # Puedes agregar más filtros según lo que recibas en data
        params = {"tableName": table_name}
        # Ejemplo: agregar filtro de edad si existe
        if "age" in data:
            params["age"] = data["age"]
...
if __name__ == "__main__":
    # Ejemplo de prueba (debes poner un token válido y el nombre de la tabla)
    test_data = {"token": "TU_TOKEN_AQUI", "tableName": "usuarios", "age": 30}
    print(main(test_data))`
};
