        ...
        <div className="modal" style={{ width: 400, maxWidth: '90vw', minWidth: 280, padding: 28, textAlign: 'center' }}>
          ...
          <form
            onSubmit={async e => {
              ...
              try {
                ...
                const projectId = renewTokenProjectId;
                ...
                if (data && data.token) {
                  ...
                  localStorage.setItem('tokenContract', projectId);
                  setShowRenewTokenModal(false);
                  setRenewTokenPassword("");
                  setRenewTokenError("");
                  setRenewTokenProjectId(projectId);
          ...
          >
            ...
            <div style={{ display: 'flex', gap: 10, marginTop: 8, justifyContent: 'center' }}>
              ...
              <button type="button" className="action-btn" style={{ background: '#23263a' }} onClick={() => { setShowRenewTokenModal(false); setRenewTokenPassword(""); setRenewTokenError(""); setRenewTokenProjectId(localStorage.getItem('tokenContract') || ""); }}>
                Cancelar
              </button>
            </div>
          </form>
