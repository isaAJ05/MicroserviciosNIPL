...
function PanelPrincipal() {
  ...
  return (
    <>
      ...
      {/* Pantalla de login */}
      <div className="login-bg" style={{ minHeight: '100vh', position: 'fixed', inset: 0, zIndex: 10, display: isLoggedIn ? 'none' : 'flex', alignItems: 'center', justifyContent: 'center', background: 'none' }}>
        <form
