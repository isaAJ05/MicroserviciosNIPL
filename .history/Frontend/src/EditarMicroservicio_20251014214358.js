      ...
      <nav className="navbar">
        ...
        {showUserPanel && (
          ...
          >
            ...
            >
              Project ID: {sessionStorage.getItem("tokenContract") || localStorage.getItem("tokenContract") || "N/A"}
            </div>
            <button
              style={{
                background: "#ff9696",
              ...
              onClick={async () => {
                try {
                  ...
                  // No usamos userPassword almacenada. Recuperar token contract de sessionStorage si existe.
                  const token = sessionStorage.getItem("tokenContract") || localStorage.getItem("tokenContract") || ""
