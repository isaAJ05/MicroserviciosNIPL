...
cd Oak-Services-NIPL
                    ...
                    <table style={{ borderCollapse: 'collapse', width: '100%', marginBottom: 18 }}>
                        ...
                        <tbody>
                            <tr>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>🧩 Nombre</td>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>Identificador del microservicio</td>
                            </tr>
                            <tr>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>⚙️ Tipo de procesamiento</td>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>Hola Mundo/ Suma/ Consulta Roble</td>
                            </tr>
                            <tr>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>🆔 ID</td>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>Identificador único</td>
                            </tr>
                            <tr>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>🔌 Puerto</td>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>Puerto Docker asignado</td>
                            </tr>
                            <tr>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>📶 Estado</td>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>Activo / Inactivo</td>
                            </tr>
                            <tr>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>🌎 Endpoint</td>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>URL local o remota</td>
                            </tr>
                            <tr>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>🧭 Acciones</td>
                                <td style={{ border: '1px solid #ccc', padding: 6 }}>Ver, Editar, Eliminar</td>
                            </tr>
                        </tbody>
                    </table>
                    <ol start={4}>
