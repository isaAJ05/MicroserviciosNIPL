...
function PanelPrincipal() {
 ...
 // Login visual simple
  ...
  const tokenContract = localStorage.getItem('tokenContract'); // <-- lo tomas de localStorage
  const url = `http://localhost:${microservice.port}/${microservice.endpoint}?tableName=inventario&token_contract=${encodeURIComponent(tokenContract)}`;
