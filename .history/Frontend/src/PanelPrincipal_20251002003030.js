          ...
          <tbody>
            {microservices.map(microservice => (
              <tr key={microservice.id}>
                ...
                <td>
                  <a href={`http://localhost:${microservice.port}/${microservice.endpoint}`} target="_blank" rel="noopener noreferrer">
                    {microservice.endpoint}
                  </a>
                </td>
                <td>
                  <button className="action-btn" title="Editar" onClick={() => {/* lógica de edición */}}>✏️</button>
