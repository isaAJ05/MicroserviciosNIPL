            ...
            <form onSubmit={handleSubmit}>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <label style={{
                  ...
                  ¿Usa operaciones en Roble?
                </label>
                <input
                  type="checkbox"
                  checked={microservice.use_roble_auth}
                  onChange={e => setMicroservice(prev => ({ ...prev, use_roble_auth: e.target.checked }))}
                  style={{ marginRight: 8 }}
                />
                <span style={{ fontSize: 12, color: lightTheme ? '#656d76' : '#8b949e' }}>
                  Marcar si este microservicio consulta o modifica datos en Roble
                </span>
              </div>
              {/* Mensajes de estado */}
              {error && (
