...
def main(data=None):
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Obtener usuario autenticado o guest
      ...
      if (savedUser) {
        try {
          ...
          console.warn('[AgregarMicroservicio] Error al parsear user:', e);
        }
      }
      console.log('[AgregarMicroservicio] Usuario que se enviará:', username);
      const bodyToSend = {
      ...
      console.log('[AgregarMicroservicio] Body enviado al backend:', bodyToSend);
      ...
      console.log('[AgregarMicroservicio] Respuesta del backend:', data);
