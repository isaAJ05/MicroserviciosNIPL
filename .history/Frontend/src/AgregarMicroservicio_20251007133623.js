...
def main(data=None):
    """
    Consulta una tabla en Roble usando credenciales y parámetros recibidos en el JSON.
    """
    try:
        token = data.get("token_contract_xyz")
        ...
        for k, v in (data or {}).items():
            if k not in ["token_contract_xyz", "email", "password", "tableName"]:
                params[k] = v
...
if __name__ == "__main__":
    test_data = {
        ...
        # Puedes agregar más filtros si quieres
        # "campo1": "valor1",
        # "campo2": "valor2"
    }
